...
Workflows combine multiple complex [flows]({% link docs/Services/FlowRepository.md %}) into a single, human understandable logical representation of a business process.
