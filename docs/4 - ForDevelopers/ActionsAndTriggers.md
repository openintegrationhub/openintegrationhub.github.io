...
that an answer of _yes_ to _Question 1_ implies an answer of _yes_ to _Question
2_.

#### Question 2: Is the structure of objects dynamic

_As explained above, an answer of yes to Question 1 implies an answer of yes to
Question 2._
...
- The structure of the objects is dynamic (_Implied by above statement_)
